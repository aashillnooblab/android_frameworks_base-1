...
public class Build extends android.os.Build {
    ...
    public static final boolean IS_DEMO_BUILD = SystemProperties.get("ro.product.mod_device", "").contains("_demo");
    ...
    public static final boolean IS_HONGMI_THREEX_CM = (IS_HONGMI_THREE && "cm".equals(SystemProperties.get("persist.sys.modem")));
    ...
    public static final int TOTAL_RAM = 6;
    ...
    public static String getRegion() {
        return SystemProperties.get("ro.miui.region", "IN");
    }
    ...
    public static String getCustVariant() {
        if (!IS_INTERNATIONAL_BUILD) {
            return SystemProperties.get("ro.miui.cust_variant", "in");
        }
